...
public:
	...
	GLuint GetWidth() const				{ return (GLuint)width; }
	GLuint GetHeight() const			{ return (GLuint)height; }

	Matrix4 GetProjMatrix() const		{ return projMatrix; }
	Matrix4 GetViewMatrix() const		{ return viewMatrix; }
	Matrix4 GetProjViewMatrix() const	{ return projMatrix * viewMatrix; }

	RENDER_TYPE GetCurrentRenderStage() { return m_renderStage; }
