...
public:
	...
	//Simulation
	void simulation_OnClothDesignChanged(ClothDesignEntity<6>* design);
...
protected:
	void GenFEMTriangle(unsigned int idx, FETriangleGeneric<6>& tri);
	void BuildStiffnessMatrix(unsigned int idx, FETriangleGeneric<6>& tri);
...
protected:
	...
	//Structural Data
	std::vector<FETriangleGeneric<6>> m_Triangles;
