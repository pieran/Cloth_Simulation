...
public:
	...
	static Vector3 RotatePointByQuaternion(const Quaternion &q, const Vector3 &point);
	...
	inline Quaternion operator-(const Vector4& b)
	{
		return Quaternion(x - b.x, y - b.y, z - b.z, w - b.w);
	}

	inline Quaternion operator*(const float& b)
	{
